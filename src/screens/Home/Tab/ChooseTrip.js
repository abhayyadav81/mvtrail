                    ...
                    {(onScrollEndDrag) => (
                        <ScrollView nestedScrollEnabled={true} onScrollEndDrag={onScrollEndDrag} showsVerticalScrollIndicator={false}>
...

                            {
                                select==0 &&
                                <View style={CarSelectScreenStyles.TaxiBoxWrap}>
                                <View style={CarSelectScreenStyles.FlexWrap}>
                                    <VectorIcon icon="FontAwesome5" name='map-marked-alt' size={SF(18)} color={Colors.gray_text_color} />
                                    <Text style={CarSelectScreenStyles.TaxiDistance}>{t("Distance_Km_Label")}</Text></View>
                            ...
                            }
                             {
                                ...
                                <View style={CarSelectScreenStyles.FlexWrap}>
                                    <VectorIcon icon="FontAwesome5" name='map-marked-alt' size={SF(18)} color={Colors.gray_text_color} />
                                    <Text style={CarSelectScreenStyles.TaxiDistance}>{t("Distance_Km_Label1")}</Text></View>
                                <View style={[CarSelectScreenStyles.FlexWrap, CarSelectScreenStyles.BorderHpri]}><VectorIcon icon="MaterialCommunityIcons" name='map-clock-outline' size={SF(23)} color={Colors.gray_text_color} /><Text style={CarSelectScreenStyles.TaxiDistance}>{t("Distance_Km_Label1")}</Text></View>
                                <View style={CarSelectScreenStyles.FlexWrap}><VectorIcon icon="Foundation" name='dollar' size={SF(25)} color={Colors.gray_text_color} /><Text style={CarSelectScreenStyles.TaxiDistance}>{t("Distance_Km_Label1")}</Text></View>
                            </View>
                            }
                             {
                                select==2 &&
                                ...
                                <View style={CarSelectScreenStyles.FlexWrap}>
                                    <VectorIcon icon="FontAwesome5" name='map-marked-alt' size={SF(18)} color={Colors.gray_text_color} />
                                    <Text style={CarSelectScreenStyles.TaxiDistance}>{t("Distance_Km_Label2")}</Text></View>
                                <View style={[CarSelectScreenStyles.FlexWrap, CarSelectScreenStyles.BorderHpri]}><VectorIcon icon="MaterialCommunityIcons" name='map-clock-outline' size={SF(23)} color={Colors.gray_text_color} /><Text style={CarSelectScreenStyles.TaxiDistance}>{t("Distance_Km_Label2")}</Text></View>
                                <View style={CarSelectScreenStyles.FlexWrap}><VectorIcon icon="Foundation" name='dollar' size={SF(25)} color={Colors.gray_text_color} /><Text style={CarSelectScreenStyles.TaxiDistance}>{t("Distance_Km_Label2")}</Text></View>
                            </View>
                            }
                            ...
                            <Button title={t("Book_Label")}  style={{ backgroundColor: 'blue' }} onPress={() => navigation.navigate(RouteName.DRIVER_SELECT_SCREEN)} />
                            <Spacing space={SH(20)} />
                        </ScrollView>
                    )}
                </BottomSheet>
