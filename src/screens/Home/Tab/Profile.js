...
import ProfileIconImg from '../../../images/ProfileImg.svg'
      ...
      <View style={ProfileTabStyle.whilistminbody}>
        <ScrollView>
          ...
          <ProfileIconImg/>
            ...
            <Text style={ProfileTabStyle.profileUserName}>{dataUser?.username}</Text>
          </View>
            ...
            <View style={ProfileTabStyle.PhoneNumberAndIcon}>
              <View style={ProfileTabStyle.BgWhiteShadow}>
                <View>
                  ...
                  <Text style={ProfileTabStyle.DigitNumberText}>{dataUser?.mobile}</Text>
                </View>
                {/* <View>
            ...
            <View style={ProfileTabStyle.PhoneNumberAndIcon}>
              <View style={ProfileTabStyle.BgWhiteShadow}>
                <View style={ProfileTabStyle.setpadiingtext}>
                  ...
                  <Text style={ProfileTabStyle.DigitNumberText}>{dataUser?.email}</Text>
                </View>
                {/* <View>
